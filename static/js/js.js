        ...
        <div class="cuadro">
          <div class="form">
            <div>
              ...
              <input type="text" name="nombre" id="input_texto" required autofocus>
            </div>
            <div>
              <label for="imagen">Imagen:</label>
              <input type="text" name="imagen" required placeholder="La URL de la imagen" pattern="(?:([^:/?#]+):)?(?://([^/?#]*))?([^?#]*\.(?:jpg|gif|bmp|tif|png))(?:\?([^#]*))?(?:#(.*))?" id="input_texto">
            </div>
            <div>
              <label for="anio">Anio:</label>
              <input type="text" name="anio" id="input_texto" required>
            </div>
            <div>
              <label for="estreno">Fecha de estreno:</label>
              <input type="text" name="estreno" placeholder="1 de Septiembre" required id="input_texto">
            </div>
            <div>
              <label for="estreno">Sinopsis</label>
              <input type="text" name="sinopsis" required id="input_texto">
            </div>
            <div>
